export default function SkillGridCard({ skill }) {
  return (
    <div className="skillGridCard group">
      ...
      <div className="font-light text-[var(--main-color-dimmed)] opacity-0 group-hover:opacity-100 transition-all group-hover:scale-110 duration-500 text-sm md:text-2xl">
        {skill.name}
      </div>
