...
export default function Particlesjs() {
      ...
      function d(d, g) {
        ...
        function j() {
          if (y) {
            ...
            for (var x = 0; x < z.length; x++) z[x].draw();
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-full bg-[var(--bg-color)] -z-50">
        <div className="vertical-centered-box" id="particles-background"></div>
        <div className="vertical-centered-box" id="particles-foreground"></div>
      </div>
    </>
  );
}
