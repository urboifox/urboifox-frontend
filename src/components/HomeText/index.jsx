  ...
  return (
    <div>
      <div
        ...
        } flex flex-col link absolute top-[21%] md:top-[20%] left-5 md:left-20 text-xs md:text-base font-extralight  transition-all duration-500 md:hover:opacity-100`}
      >
      ...
      <div
        className={`${
          darkTheme ? "text-white opacity-[45%]" : "text-dark opacity-70"
        } flex flex-col ml-10 link absolute bottom-[22%] md:bottom-[20%] right-10 md:right-20  text-xs md:text-base font-extralight transition-all duration-500 lg:hover:opacity-100`}
      >
        <span className="block">{"<p>"}</span>
        <div className="inline-block translate-x-5">
          <div className="wrapper">
